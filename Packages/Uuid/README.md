...
Formatting and comparison borrow UUID values directly. Parsing and generation retain raw scalar error-output pointers, and entropy retains raw byte buffers; neither kind transfers ownership.
