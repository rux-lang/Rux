...
Rux currently requires Clang 23.1 or newer, CMake 3.31 or newer, Ninja 1.13.2 or newer, a recent Git installation, and the Windows SDK and C runtime supplied by Visual Studio.
