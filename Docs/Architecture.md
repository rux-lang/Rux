...
| `Optimization`         | Bounded profile-selected HIR/LIR pass pipelines, CFG validation, and typed constant evaluation | BuildInfo, Diagnostics, HIR, and LIR  |
