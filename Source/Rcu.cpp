...
public:
    ...
    void Qword(uint64_t q) {
        for (int i = 0; i < 8; ++i) { out_.push_back(q & 0xFF); q >>= 8; }
    }
    ...
    void MovRbpRsp()          { Byte(0x48); Byte(0x89); Byte(0xE5); }
    void SubRspImm32(int32_t n){ Byte(0x48); Byte(0x81); Byte(0xEC); Dword(static_cast<uint32_t>(n)); }
    void Leave()              { Byte(0xC9); }
    void Ret()                { Byte(0xC3); }

    // ── RAX ↔ [RBP + disp32] ─────────────────────────────────────────────────
    void MovRaxLoad(int32_t d)        { Byte(0x48); Byte(0x8B); Byte(0x85); Dword(u(d)); }
    void MovRaxStore(int32_t d)       { Byte(0x48); Byte(0x89); Byte(0x85); Dword(u(d)); }
    void MovEaxLoad(int32_t d)        {             Byte(0x8B); Byte(0x85); Dword(u(d)); }
    void MovEaxStore(int32_t d)       {             Byte(0x89); Byte(0x85); Dword(u(d)); }
    void MovzxRaxWord(int32_t d)      { Byte(0x48); Byte(0x0F); Byte(0xB7); Byte(0x85); Dword(u(d)); }
    void MovzxRaxByte(int32_t d)      { Byte(0x48); Byte(0x0F); Byte(0xB6); Byte(0x85); Dword(u(d)); }
    void MovsxdRaxDword(int32_t d)    { Byte(0x48); Byte(0x63); Byte(0x85); Dword(u(d)); }
    void MovsxRaxWord(int32_t d)      { Byte(0x48); Byte(0x0F); Byte(0xBF); Byte(0x85); Dword(u(d)); }
    void MovsxRaxByte(int32_t d)      { Byte(0x48); Byte(0x0F); Byte(0xBE); Byte(0x85); Dword(u(d)); }
    void MovAxStore(int32_t d)        { Byte(0x66); Byte(0x89); Byte(0x85); Dword(u(d)); }
    void MovAlStore(int32_t d)        {             Byte(0x88); Byte(0x85); Dword(u(d)); }

    // ── R10 ↔ [RBP + disp32] ─────────────────────────────────────────────────
    void MovR10Load(int32_t d)        { Byte(0x4C); Byte(0x8B); Byte(0x95); Dword(u(d)); }
    void MovR10Store(int32_t d)       { Byte(0x4C); Byte(0x89); Byte(0x95); Dword(u(d)); }
    void MovzxR10Word(int32_t d)      { Byte(0x4C); Byte(0x0F); Byte(0xB7); Byte(0x95); Dword(u(d)); }
    void MovzxR10Byte(int32_t d)      { Byte(0x4C); Byte(0x0F); Byte(0xB6); Byte(0x95); Dword(u(d)); }
    void MovsxdR10Dword(int32_t d)    { Byte(0x4C); Byte(0x63); Byte(0x95); Dword(u(d)); }
    void MovsxR10Word(int32_t d)      { Byte(0x4C); Byte(0x0F); Byte(0xBF); Byte(0x95); Dword(u(d)); }
    void MovsxR10Byte(int32_t d)      { Byte(0x4C); Byte(0x0F); Byte(0xBE); Byte(0x95); Dword(u(d)); }
    void MovR10dLoad(int32_t d)       { Byte(0x44); Byte(0x8B); Byte(0x95); Dword(u(d)); }

    // ── R11 ↔ [RBP + disp32] ─────────────────────────────────────────────────
    void MovR11Load(int32_t d)        { Byte(0x4C); Byte(0x8B); Byte(0x9D); Dword(u(d)); }
    void MovR11Store(int32_t d)       { Byte(0x4C); Byte(0x89); Byte(0x9D); Dword(u(d)); }

    // ── RCX ↔ stack (for shift count) ────────────────────────────────────────
    void MovRcxLoad(int32_t d)        { Byte(0x48); Byte(0x8B); Byte(0x8D); Dword(u(d)); }
    ...
    void MovssXmmNLoad(int n, int32_t d) {
        Byte(0xF3); Byte(0x0F); Byte(0x10);
        Byte(static_cast<uint8_t>(0x80 | (n << 3) | 5)); Dword(u(d));
    }
    // MOVSD xmmN, [rbp + d]
    void MovsdXmmNLoad(int n, int32_t d) {
        Byte(0xF2); Byte(0x0F); Byte(0x10);
        Byte(static_cast<uint8_t>(0x80 | (n << 3) | 5)); Dword(u(d));
    }

    // ── XMM0 / XMM1 ↔ [RBP + disp32] ────────────────────────────────────────
    void MovssXmm0Load(int32_t d) { Byte(0xF3); Byte(0x0F); Byte(0x10); Byte(0x85); Dword(u(d)); }
    void MovsdXmm0Load(int32_t d) { Byte(0xF2); Byte(0x0F); Byte(0x10); Byte(0x85); Dword(u(d)); }
    void MovssXmm1Load(int32_t d) { Byte(0xF3); Byte(0x0F); Byte(0x10); Byte(0x8D); Dword(u(d)); }
    void MovsdXmm1Load(int32_t d) { Byte(0xF2); Byte(0x0F); Byte(0x10); Byte(0x8D); Dword(u(d)); }
    void MovssXmm0Store(int32_t d){ Byte(0xF3); Byte(0x0F); Byte(0x11); Byte(0x85); Dword(u(d)); }
    void MovsdXmm0Store(int32_t d){ Byte(0xF2); Byte(0x0F); Byte(0x11); Byte(0x85); Dword(u(d)); }
    void MovssXmm1Store(int32_t d){ Byte(0xF3); Byte(0x0F); Byte(0x11); Byte(0x8D); Dword(u(d)); }
    void MovsdXmm1Store(int32_t d){ Byte(0xF2); Byte(0x0F); Byte(0x11); Byte(0x8D); Dword(u(d)); }

    // ── XMM0 / XMM1, [RIP + rel32] (RIP-relative rodata load) ───────────────
    void MovssXmm0Rip(uint32_t& relocOff) { Byte(0xF3); Byte(0x0F); Byte(0x10); Byte(0x05); relocOff=Size(); Dword(0); }
    void MovsdXmm0Rip(uint32_t& relocOff) { Byte(0xF2); Byte(0x0F); Byte(0x10); Byte(0x05); relocOff=Size(); Dword(0); }
    void MovssXmm1Rip(uint32_t& relocOff) { Byte(0xF3); Byte(0x0F); Byte(0x10); Byte(0x0D); relocOff=Size(); Dword(0); }
    void MovsdXmm1Rip(uint32_t& relocOff) { Byte(0xF2); Byte(0x0F); Byte(0x10); Byte(0x0D); relocOff=Size(); Dword(0); }

    // ── Immediate loads ───────────────────────────────────────────────────────
    void MovRaxImm64(int64_t v)  { Byte(0x48); Byte(0xB8); Qword(static_cast<uint64_t>(v)); }
    void MovEaxImm32(int32_t v)  { Byte(0xB8); Dword(static_cast<uint32_t>(v)); }

    // ── LEA / MOV rax, [rip + rel32] ─────────────────────────────────────────
    void LeaRaxRip(uint32_t& relocOff)    { Byte(0x48); Byte(0x8D); Byte(0x05); relocOff=Size(); Dword(0); }
    void MovRaxRip(uint32_t& relocOff)    { Byte(0x48); Byte(0x8B); Byte(0x05); relocOff=Size(); Dword(0); }
    void LeaRaxStack(int32_t d)            { Byte(0x48); Byte(0x8D); Byte(0x85); Dword(u(d)); }

    // ── Register-to-register ─────────────────────────────────────────────────
    void MovRaxR10()   { Byte(0x4C); Byte(0x89); Byte(0xD0); } // mov rax, r10
    void MovRcxR11()   { Byte(0x4C); Byte(0x89); Byte(0xD9); } // mov rcx, r11
    void MovRaxRdx()   { Byte(0x48); Byte(0x8B); Byte(0xC2); } // mov rax, rdx

    // ── Integer arithmetic (RAX op R10 → RAX) ────────────────────────────────
    void AddRaxR10()   { Byte(0x4C); Byte(0x01); Byte(0xD0); }
    void SubRaxR10()   { Byte(0x4C); Byte(0x29); Byte(0xD0); }
    void AndRaxR10()   { Byte(0x4C); Byte(0x21); Byte(0xD0); }
    void OrRaxR10()    { Byte(0x4C); Byte(0x09); Byte(0xD0); }
    void XorRaxR10()   { Byte(0x4C); Byte(0x31); Byte(0xD0); }
    void ImulRaxR10()  { Byte(0x49); Byte(0x0F); Byte(0xAF); Byte(0xC2); }
    void NegRax()      { Byte(0x48); Byte(0xF7); Byte(0xD8); }
    void NotRax()      { Byte(0x48); Byte(0xF7); Byte(0xD0); }

    // ── Division ─────────────────────────────────────────────────────────────
    void Cqo()         { Byte(0x48); Byte(0x99); }
    void XorRdxRdx()   { Byte(0x48); Byte(0x31); Byte(0xD2); }
    void IdivR10()     { Byte(0x49); Byte(0xF7); Byte(0xFA); }
    void DivR10()      { Byte(0x49); Byte(0xF7); Byte(0xF2); }

    // ── Shifts ───────────────────────────────────────────────────────────────
    void ShlRaxCl()    { Byte(0x48); Byte(0xD3); Byte(0xE0); }
    void ShrRaxCl()    { Byte(0x48); Byte(0xD3); Byte(0xE8); }
    void SarRaxCl()    { Byte(0x48); Byte(0xD3); Byte(0xF8); }

    // ── Comparisons ──────────────────────────────────────────────────────────
    void TestRaxRax()        { Byte(0x48); Byte(0x85); Byte(0xC0); }
    void CmpRaxR10()         { Byte(0x4C); Byte(0x39); Byte(0xD0); }
    void CmpRaxImm32(int32_t v){ Byte(0x48); Byte(0x81); Byte(0xF8); Dword(u(v)); }

    // SETcc AL + MOVZX RAX, AL
    void SeteAl()   { Byte(0x0F); Byte(0x94); Byte(0xC0); }
    void SetneAl()  { Byte(0x0F); Byte(0x95); Byte(0xC0); }
    void SetlAl()   { Byte(0x0F); Byte(0x9C); Byte(0xC0); }
    void SetleAl()  { Byte(0x0F); Byte(0x9E); Byte(0xC0); }
    void SetgAl()   { Byte(0x0F); Byte(0x9F); Byte(0xC0); }
    void SetgeAl()  { Byte(0x0F); Byte(0x9D); Byte(0xC0); }
    void SetbAl()   { Byte(0x0F); Byte(0x92); Byte(0xC0); }
    void SetbeAl()  { Byte(0x0F); Byte(0x96); Byte(0xC0); }
    void SetaAl()   { Byte(0x0F); Byte(0x97); Byte(0xC0); }
    void SetaeAl()  { Byte(0x0F); Byte(0x93); Byte(0xC0); }
    void MovzxRaxAl(){ Byte(0x48); Byte(0x0F); Byte(0xB6); Byte(0xC0); }

    // ── Float arithmetic (XMM0 op XMM1 → XMM0) ───────────────────────────────
    void AddssXmm01(){ Byte(0xF3); Byte(0x0F); Byte(0x58); Byte(0xC1); }
    void SubssXmm01(){ Byte(0xF3); Byte(0x0F); Byte(0x5C); Byte(0xC1); }
    void MulssXmm01(){ Byte(0xF3); Byte(0x0F); Byte(0x59); Byte(0xC1); }
    void DivssXmm01(){ Byte(0xF3); Byte(0x0F); Byte(0x5E); Byte(0xC1); }
    void AddsdXmm01(){ Byte(0xF2); Byte(0x0F); Byte(0x58); Byte(0xC1); }
    void SubsdXmm01(){ Byte(0xF2); Byte(0x0F); Byte(0x5C); Byte(0xC1); }
    void MulsdXmm01(){ Byte(0xF2); Byte(0x0F); Byte(0x59); Byte(0xC1); }
    void DivsdXmm01(){ Byte(0xF2); Byte(0x0F); Byte(0x5E); Byte(0xC1); }

    // ── Float compare ─────────────────────────────────────────────────────────
    void UcomissXmm01(){ Byte(0x0F); Byte(0x2E); Byte(0xC1); }
    void UcomisdXmm01(){ Byte(0x66); Byte(0x0F); Byte(0x2E); Byte(0xC1); }

    // ── Float sign negate (XOR with mask) ────────────────────────────────────
    void XorpsXmm01() { Byte(0x0F); Byte(0x57); Byte(0xC1); }
    void XorpdXmm01() { Byte(0x66); Byte(0x0F); Byte(0x57); Byte(0xC1); }

    // ── Float conversions ─────────────────────────────────────────────────────
    void Cvtsi2ssXmm0Rax(){ Byte(0xF3); Byte(0x48); Byte(0x0F); Byte(0x2A); Byte(0xC0); }
    void Cvtsi2sdXmm0Rax(){ Byte(0xF2); Byte(0x48); Byte(0x0F); Byte(0x2A); Byte(0xC0); }
    void CvttsssiRaxXmm0(){ Byte(0xF3); Byte(0x48); Byte(0x0F); Byte(0x2C); Byte(0xC0); }
    void CvttsdsiRaxXmm0(){ Byte(0xF2); Byte(0x48); Byte(0x0F); Byte(0x2C); Byte(0xC0); }
    void CvtsssdXmm0()    { Byte(0xF3); Byte(0x0F); Byte(0x5A); Byte(0xC0); }
    void CvtsdssXmm0()    { Byte(0xF2); Byte(0x0F); Byte(0x5A); Byte(0xC0); }

    // ── Control flow ─────────────────────────────────────────────────────────
    void Jmp(uint32_t& patchOff) { Byte(0xE9); patchOff=Size(); Dword(0); }
    void Jz (uint32_t& patchOff) { Byte(0x0F); Byte(0x84); patchOff=Size(); Dword(0); }
    void Jnz(uint32_t& patchOff) { Byte(0x0F); Byte(0x85); patchOff=Size(); Dword(0); }
    void Je (uint32_t& patchOff) { Byte(0x0F); Byte(0x84); patchOff=Size(); Dword(0); }
    void Call(uint32_t& relocOff) { Byte(0xE8); relocOff=Size(); Dword(0); }
    void CallR10()                { Byte(0x41); Byte(0xFF); Byte(0xD2); }

    // ── Aggregate helpers ─────────────────────────────────────────────────────
    void ImulR11R10Imm32(int32_t v){ Byte(0x4D); Byte(0x69); Byte(0xDA); Dword(u(v)); }
    void AddRaxR11()               { Byte(0x4C); Byte(0x01); Byte(0xD8); }
    void LeaRaxRaxDisp(int32_t v)  { Byte(0x48); Byte(0x8D); Byte(0x80); Dword(u(v)); }
...
struct JumpPatch { uint32_t patchOff; uint32_t targetBlock; };
...
private:
    ...
    uint32_t InternF32(const std::string& val) {
        ...
        for (int i = 0; i < 4; ++i) { rodataData_.push_back(bits & 0xFF); bits >>= 8; }
    ...
    uint32_t InternF64(const std::string& val) {
        ...
        for (int i = 0; i < 8; ++i) { rodataData_.push_back(bits & 0xFF); bits >>= 8; }
    ...
    uint32_t InternF32SignMask() {
        ...
        rodataData_.push_back(0x00); rodataData_.push_back(0x00);
        rodataData_.push_back(0x00); rodataData_.push_back(0x80);
        RcuSymbol s;
    ...
    void PrepassFunc(const LirFunc& func) {
        nextOff_ = 0; frameSize_ = 0;
        slotMap_.clear(); allocaData_.clear(); regTypes_.clear(); phiMoves_.clear();
    ...
    void GenInstr(const LirInstr& instr) {
        ...
        case LirOpcode::Load: {
            ...
            if (!instr.strArg.empty()) {
                ...
                if (IsFloat(t)) {
                    ...
                    if (sz == 4) {
                        enc_.Byte(0xF3); enc_.Byte(0x41); enc_.Byte(0x0F);
                        enc_.Byte(0x10); enc_.Byte(0x02);
                    } else {
                        enc_.Byte(0xF2); enc_.Byte(0x41); enc_.Byte(0x0F);
                        enc_.Byte(0x10); enc_.Byte(0x02);
                    }
                    StoreA(instr.dst, t);
                    break;
                } else if (sz == 8 || sz == 0) {
                    enc_.Byte(0x49); enc_.Byte(0x8B); enc_.Byte(0x02); // mov rax, [r10]
                } else if (t.IsSigned()) {
                    if (sz == 4) {
                        enc_.Byte(0x49); enc_.Byte(0x63); enc_.Byte(0x02); // movsxd rax,[r10]
                    } else if (sz == 2) {
                        enc_.Byte(0x49); enc_.Byte(0x0F); enc_.Byte(0xBF); enc_.Byte(0x02);
                    } else {
                        enc_.Byte(0x49); enc_.Byte(0x0F); enc_.Byte(0xBE); enc_.Byte(0x02);
                    }
                } else {
                    if (sz == 4) {
                        enc_.Byte(0x45); enc_.Byte(0x8B); enc_.Byte(0x02); // mov r8d,[r10] → rax by copy
                        enc_.Byte(0x4D); enc_.Byte(0x8B); enc_.Byte(0xC0); // mov r8,r8 nop
                    ...
                    if (sz == 2) {
                        enc_.Byte(0x49); enc_.Byte(0x0F); enc_.Byte(0xB7); enc_.Byte(0x02);
                    } else {
                        enc_.Byte(0x49); enc_.Byte(0x0F); enc_.Byte(0xB6); enc_.Byte(0x02);
                    }
                }
            }
        ...
        case LirOpcode::Store: {
            ...
            if (IsFloat(t)) {
                ...
                if (ss == 8) {
                    enc_.Byte(0x49); enc_.Byte(0x89); enc_.Byte(0x03);
                } else if (ss == 4) {
                    enc_.Byte(0x41); enc_.Byte(0x89); enc_.Byte(0x03);
                } else if (ss == 2) {
                    enc_.Byte(0x66); enc_.Byte(0x41); enc_.Byte(0x89); enc_.Byte(0x03);
                } else {
                    enc_.Byte(0x41); enc_.Byte(0x88); enc_.Byte(0x03);
                }
            }
            break;
        }

        case LirOpcode::Add: case LirOpcode::Sub:
        case LirOpcode::And: case LirOpcode::Or: case LirOpcode::Xor: {
            const TypeRef& t = instr.type;
            if (IsFloat(t)) {
                LoadA(instr.srcs[0], t); LoadB(instr.srcs[1], t);
                bool f32 = (t.kind == TypeRef::Kind::Float32);
                if (instr.op == LirOpcode::Add) { if (f32) enc_.AddssXmm01(); else enc_.AddsdXmm01(); }
                else if (instr.op == LirOpcode::Sub) { if (f32) enc_.SubssXmm01(); else enc_.SubsdXmm01(); }
                else { if (f32) enc_.AddssXmm01(); else enc_.AddsdXmm01(); } // bitwise on float: fallback
                StoreA(instr.dst, t);
            } else {
                LoadA(instr.srcs[0], t); LoadB(instr.srcs[1], t);
        ...
        case LirOpcode::Mul: {
            ...
            if (IsFloat(t)) {
                LoadA(instr.srcs[0], t); LoadB(instr.srcs[1], t);
                if (t.kind == TypeRef::Kind::Float32) enc_.MulssXmm01(); else enc_.MulsdXmm01();
            } else {
                LoadA(instr.srcs[0], t); LoadB(instr.srcs[1], t);
                enc_.ImulRaxR10();
            }
        ...
        case LirOpcode::Div: case LirOpcode::Mod: {
            const TypeRef& t = instr.type;
            if (IsFloat(t)) {
                LoadA(instr.srcs[0], t); LoadB(instr.srcs[1], t);
                if (t.kind == TypeRef::Kind::Float32) enc_.DivssXmm01(); else enc_.DivsdXmm01();
                StoreA(instr.dst, t);
            } else {
                LoadA(instr.srcs[0], t); LoadB(instr.srcs[1], t);
                if (t.IsSigned()) { enc_.Cqo(); enc_.IdivR10(); }
                else              { enc_.XorRdxRdx(); enc_.DivR10(); }
        ...
        case LirOpcode::Pow: {
            ...
            if (IsFloat(t)) {
                ...
                uint32_t ro; enc_.Call(ro); AddTextReloc(ro, sym);
            } else {
        ...
        case LirOpcode::Shl: case LirOpcode::Shr: {
            const TypeRef& t = instr.type;
        ...
        case LirOpcode::Neg: {
            ...
            if (IsFloat(t)) {
                ...
                uint32_t ro;
                if (f32) enc_.MovssXmm1Rip(ro); else enc_.MovsdXmm1Rip(ro);
                AddTextReloc(ro, maskSym);
                if (f32) enc_.XorpsXmm01(); else enc_.XorpdXmm01();
                StoreA(instr.dst, t);
            } else {
                LoadA(instr.srcs[0], t);
                enc_.NegRax();
        ...
        case LirOpcode::CmpGt: case LirOpcode::CmpGe: {
            ...
            if (IsFloat(lhsT)) {
                ...
                switch (instr.op) {
                    case LirOpcode::CmpEq: enc_.SeteAl();  break;
                    case LirOpcode::CmpNe: enc_.SetneAl(); break;
                    case LirOpcode::CmpLt: enc_.SetbAl();  break;
                    case LirOpcode::CmpLe: enc_.SetbeAl(); break;
                    case LirOpcode::CmpGt: enc_.SetaAl();  break;
                    default:               enc_.SetaeAl(); break;
                }
            } else {
                enc_.CmpRaxR10();
                ...
                switch (instr.op) {
                    case LirOpcode::CmpEq: enc_.SeteAl();                           break;
                    case LirOpcode::CmpNe: enc_.SetneAl();                          break;
                    case LirOpcode::CmpLt: sig ? enc_.SetlAl()  : enc_.SetbAl();   break;
                    case LirOpcode::CmpLe: sig ? enc_.SetleAl() : enc_.SetbeAl();  break;
                    case LirOpcode::CmpGt: sig ? enc_.SetgAl()  : enc_.SetaAl();   break;
                    default:               sig ? enc_.SetgeAl() : enc_.SetaeAl();  break;
                }
            }
            enc_.MovzxRaxAl();
            StoreA(instr.dst, TypeRef::MakeBool());
        ...
        case LirOpcode::Cast: {
            ...
            TypeRef srcT = regTypes_.count(instr.srcs[0])
                            ? regTypes_.at(instr.srcs[0]) : dstT;
            ...
            if (IsFloat(p.type)) {
                if (fltIdx < 8) {
                    ...
                    if (fltIdx == 0) {
                        ...
                        // MOVSS [rbp+d], xmmN
                        enc_.Byte(0xF3); enc_.Byte(0x0F); enc_.Byte(0x11);
...
RcuFile RcuCodeGen::Generate() {
    ...
    // Parse rux version from RUX_VERSION string "M.m.p"
    {
        ...
        auto parseNum = [](const char* s, unsigned& out) -> const char* {
            while (*s && (*s < '0' || *s > '9')) ++s;
            while (*s >= '0' && *s <= '9') { out = out * 10 + static_cast<unsigned>(*s - '0'); ++s; }
            return s;
        };
...
private:
    ...
    std::vector<uint8_t> Build() {
        ...
        // [0-3]  magic
        out.push_back(0x52); out.push_back(0x43); out.push_back(0x55); out.push_back(0x00);
        // [4-5]  version 1.0
        ...
        if (f_.hasMetadata) {
            ...
            // magic
            out.push_back(0x4D); out.push_back(0x45); out.push_back(0x54); out.push_back(0x41);
...
public:
    static std::string Dump(const RcuFile& f) {
        ...
        for (size_t i = 0; i < f.symbols.size(); ++i) {
            ...
            const char* kindStr = "?";
            switch (s.kind) {
                case RcuSymKind::Func:       kindStr = "FUNC";       break;
                case RcuSymKind::Data:       kindStr = "DATA";       break;
                case RcuSymKind::Const:      kindStr = "CONST";      break;
                case RcuSymKind::Section:    kindStr = "SECTION";    break;
                case RcuSymKind::File:       kindStr = "FILE";       break;
                case RcuSymKind::ExternFunc: kindStr = "EXTFUNC";   break;
                case RcuSymKind::ExternData: kindStr = "EXTDATA";   break;
            }
        ...
        for (const auto& sec : f.sections)
            if (!sec.relocs.empty()) { anyReloc = true; break; }
