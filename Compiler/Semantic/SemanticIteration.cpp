...
const FuncDecl *SemanticAnalyzerContext::LookupIteratorAdvance(const TypeRef &type) const {
...
std::optional<SemanticAnalyzerContext::IterationShape>
SemanticAnalyzerContext::IterationShapeOf(const TypeRef &subject) {
...
void SemanticAnalyzerContext::RecordIteration(const ForStmt &statement, const IterationShape &shape) {
...
void SemanticAnalyzerContext::EmitNotIterable(const SourceLocation location, const TypeRef &subject) const {
...
void SemanticAnalyzerContext::ValidateIteratorConvention(const FuncDecl &declaration, const bool isMethod) {
