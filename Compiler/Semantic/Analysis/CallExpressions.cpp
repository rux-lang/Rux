...
TypeRef AnalysisContext::CheckCallExpression(const CallExpr &expression) {
...
Symbol *AnalysisContext::LookupCalleeSymbol(const Expr &callee) const {
...
void AnalysisContext::EmitCallSiteDiagnostics(const Decl &declaration, const SourceLocation location) const {
...
void AnalysisContext::RecordFunctionBinding(const CallExpr &call, const FuncDecl &declaration,
...
void AnalysisContext::RecordExternBinding(const CallExpr &call, const ExternFuncDecl &declaration) {
    ResolvedCallableBinding binding;
