...
bool AnalysisContext::TypeHasDirectDestructor(const std::string &baseName) const {
...
std::string AnalysisContext::DropGlueSymbol(const TypeRef &type) {
...
std::vector<DropGlueStep> AnalysisContext::BuildDropGlueSteps(const TypeRef &type,
...
void AnalysisContext::SynthesizeResolvedDropGlue() {
    dropGluePlans.clear();
