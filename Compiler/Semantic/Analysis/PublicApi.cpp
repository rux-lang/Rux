...
void AnalysisContext::ValidatePublicType(const TypeExpr &type, const std::string_view subject,
...
void AnalysisContext::ValidatePublicTypeParameters(const std::vector<TypeParameter> &parameters,
                                                   const std::string_view subject,
...
void AnalysisContext::ValidatePublicFunction(const FuncDecl &function, const std::string_view subject,
...
void AnalysisContext::ValidatePublicDeclaration(const Decl &declaration) {
