...
void AnalysisContext::ValidateSuffixedIntegerLiteral(const LiteralExpr &literal, const bool negative) {
...
bool AnalysisContext::CastTypesAreCompatible(const TypeRef &operand, const TypeRef &target) const {
...
void AnalysisContext::CheckCast(const TypeRef &operand, const TypeRef &target, const SourceLocation location) {
...
TypeRef AnalysisContext::CheckUnary(const TokenKind op, const TypeRef &operand, const SourceLocation location) {
...
bool AnalysisContext::BuildVariantEqualityPlan(const TypeRef &type, const SourceLocation useLocation,
                                               std::unordered_set<std::string> &activeTypes) {
...
bool AnalysisContext::BuildVariantEqualityPayload(VariantEqualityPayload &payload, const SourceLocation useLocation,
...
bool AnalysisContext::PlaceIsImmutable(const Expr &place) {
...
bool AnalysisContext::PlaceIsWritable(const Expr &place, const TypeRef &placeType) {
    if (const auto *unary = dynamic_cast<const UnaryExpr *>(&place); unary && unary->op == TokenKind::Star) {
...
bool AnalysisContext::CheckAssignableTarget(const Expr &target, const TypeRef &targetType,
