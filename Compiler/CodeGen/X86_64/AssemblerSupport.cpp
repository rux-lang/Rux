...
const SseForm *LookupSseForm(const std::string_view mnemonic) {
    ...
    static const std::unordered_map<std::string_view, SseForm> forms = {
        ...
        {"sqrtpd", {SseFormKind::RegRm, 0x66, 0x51, 0}},   {"sqrtps", {SseFormKind::RegRm, 0x00, 0x51, 0}},
        {"addsd", {SseFormKind::RegRm, 0xF2, 0x58, 0}},    {"addss", {SseFormKind::RegRm, 0xF3, 0x58, 0}},
        {"addpd", {SseFormKind::RegRm, 0x66, 0x58, 0}},    {"addps", {SseFormKind::RegRm, 0x00, 0x58, 0}},
        {"subsd", {SseFormKind::RegRm, 0xF2, 0x5C, 0}},    {"subss", {SseFormKind::RegRm, 0xF3, 0x5C, 0}},
        {"subpd", {SseFormKind::RegRm, 0x66, 0x5C, 0}},    {"subps", {SseFormKind::RegRm, 0x00, 0x5C, 0}},
        {"mulsd", {SseFormKind::RegRm, 0xF2, 0x59, 0}},    {"mulss", {SseFormKind::RegRm, 0xF3, 0x59, 0}},
        {"mulpd", {SseFormKind::RegRm, 0x66, 0x59, 0}},    {"mulps", {SseFormKind::RegRm, 0x00, 0x59, 0}},
        {"divsd", {SseFormKind::RegRm, 0xF2, 0x5E, 0}},    {"divss", {SseFormKind::RegRm, 0xF3, 0x5E, 0}},
        {"divpd", {SseFormKind::RegRm, 0x66, 0x5E, 0}},    {"divps", {SseFormKind::RegRm, 0x00, 0x5E, 0}},
        {"minsd", {SseFormKind::RegRm, 0xF2, 0x5D, 0}},    {"minss", {SseFormKind::RegRm, 0xF3, 0x5D, 0}},
        {"minpd", {SseFormKind::RegRm, 0x66, 0x5D, 0}},    {"minps", {SseFormKind::RegRm, 0x00, 0x5D, 0}},
        {"maxsd", {SseFormKind::RegRm, 0xF2, 0x5F, 0}},    {"maxss", {SseFormKind::RegRm, 0xF3, 0x5F, 0}},
        {"maxpd", {SseFormKind::RegRm, 0x66, 0x5F, 0}},    {"maxps", {SseFormKind::RegRm, 0x00, 0x5F, 0}},
        {"paddb", {SseFormKind::RegRm, 0x66, 0xFC, 0}},    {"paddw", {SseFormKind::RegRm, 0x66, 0xFD, 0}},
        {"paddd", {SseFormKind::RegRm, 0x66, 0xFE, 0}},    {"paddq", {SseFormKind::RegRm, 0x66, 0xD4, 0}},
        {"psubb", {SseFormKind::RegRm, 0x66, 0xF8, 0}},    {"psubw", {SseFormKind::RegRm, 0x66, 0xF9, 0}},
        {"psubd", {SseFormKind::RegRm, 0x66, 0xFA, 0}},    {"psubq", {SseFormKind::RegRm, 0x66, 0xFB, 0}},
        {"pmullw", {SseFormKind::RegRm, 0x66, 0xD5, 0}},   {"cvtsd2ss", {SseFormKind::RegRm, 0xF2, 0x5A, 0}},
        {"cvtss2sd", {SseFormKind::RegRm, 0xF3, 0x5A, 0}}, {"ucomisd", {SseFormKind::RegRm, 0x66, 0x2E, 0}},
        {"ucomiss", {SseFormKind::RegRm, 0x00, 0x2E, 0}},  {"comisd", {SseFormKind::RegRm, 0x66, 0x2F, 0}},
        {"comiss", {SseFormKind::RegRm, 0x00, 0x2F, 0}},   {"xorps", {SseFormKind::RegRm, 0x00, 0x57, 0}},
        {"xorpd", {SseFormKind::RegRm, 0x66, 0x57, 0}},    {"andps", {SseFormKind::RegRm, 0x00, 0x54, 0}},
        {"andpd", {SseFormKind::RegRm, 0x66, 0x54, 0}},    {"orps", {SseFormKind::RegRm, 0x00, 0x56, 0}},
        {"orpd", {SseFormKind::RegRm, 0x66, 0x56, 0}},     {"andnps", {SseFormKind::RegRm, 0x00, 0x55, 0}},
        {"andnpd", {SseFormKind::RegRm, 0x66, 0x55, 0}},   {"pxor", {SseFormKind::RegRm, 0x66, 0xEF, 0}},
        {"pand", {SseFormKind::RegRm, 0x66, 0xDB, 0}},     {"por", {SseFormKind::RegRm, 0x66, 0xEB, 0}},
        {"movsd", {SseFormKind::Move, 0xF2, 0x10, 0x11}},  {"movss", {SseFormKind::Move, 0xF3, 0x10, 0x11}},
        {"movups", {SseFormKind::Move, 0x00, 0x10, 0x11}}, {"movupd", {SseFormKind::Move, 0x66, 0x10, 0x11}},
        {"movaps", {SseFormKind::Move, 0x00, 0x28, 0x29}}, {"movapd", {SseFormKind::Move, 0x66, 0x28, 0x29}},
    };
