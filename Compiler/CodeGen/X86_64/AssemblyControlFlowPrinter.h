...
// Owns complete function traversal plus the x86-64 text for calls, runtime
// failure paths, phi-edge moves, branches, returns, switches, and epilogues.
// Scalar and memory instructions remain delegated to AssemblyInstructionPrinter.
