...
/// A supported OS/architecture pair. Construction is restricted to validated parsing, supported enum pairs, or the
/// compiler host, so Unknown can never enter target selection through this type.
class TargetTriple {
public:
